    ...
    var pictures = document.querySelectorAll('.pictures');//存储图片
    var arrow = document.querySelectorAll('.arrow');//存储左右箭头
    var button = document.querySelectorAll('.button');//存储下部圆圈
